...
// ! To Do
// 1. Nummer 1 bis Arry Länge ausgeben
// 2. Random Nummer
// 3.Randombild ausgeben lassen 211

const divBox = document.querySelector("#content");

const randomImg = () => {
  let number = Math.round(Math.random() * 26);
  console.log(number);
  divBox.innerHTML = ` <img  src="${data[number].download_url}"> `;
};
